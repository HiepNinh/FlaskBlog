# -*- coding: utf-8 -*-
"""
Created on Fri Dec 11 13:31:40 2020
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash(f'Unsuccessfully logged in. Please check email or password', 'danger')
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Reset password token has been send to your email', 'info')
